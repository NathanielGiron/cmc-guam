...
<body>
	...
	<footer>
		<div class="wrapper footer">
			<ul>
				...
				<li class="links">
					<ul>
						<li><a href="#">Yigo</a></li>
						<li><a href="#">Dededo</a></li>
						<li><a href="#">Barrigada</a></li>
						<li><a href="#">Tamuning</a></li>
						<li><a href="#">Hagatña</a></li>
					</ul>
				</li>
		...
		<div class="copyrights wrapper">
			Copyright © 2015 <a href="http://nathanielgiron.github.io" target="_blank" class="ph_link" title="">nathanielgiron.github.io</a>. All Rights Reserved.
		</div>
	</footer><!--  end footer  -->
